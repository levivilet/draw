    ...
    return {
      ...
      node: {
        ...
        dom: [
          {
            childCount: children.childCount,
            className: 'DrawMarkdownEmphasis',
...
const renderListItem = (line: string): readonly VirtualDomNode[] => {
  ...
  return [
    {
      childCount: children.childCount,
      className: 'DrawMarkdownListItem',
...
const renderParagraph = (
  ...
  return [
    {
      childCount: children.childCount,
      className: 'DrawMarkdownParagraph',
